...
import { getNewHsl, getDegrees, isUpperCase, getHandleValue, getGradientType, computeSquareXY, compareGradients, computePickerPosition, } from './utils/utils.js';
...
export default function PickerContextWrapper({ value, bounds, children, onChange, squareSize, hideOpacity, squareHeight, }) {
    ...
    const currentColorObj = indexedColors?.filter((c) => isUpperCase(c.value))[0] ||
        indexedColors[0];
